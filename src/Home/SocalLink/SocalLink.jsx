...
const SocalLink = () => {
    return (
        <div className='mx-auto px-10 bg-base-200'>
                ...
                <div className="hero-content my-12 flex-col lg:flex-row-reverse">
                    <div className="text-center  w-1/2 lg:ms-16 lg:text-left">
                        <p className='text-xl text-black font-sans'>At
                            <span className='font-bold'> EURO FLY </span> , we take pride in facilitating dreams, connections, and opportunities. Our mission is to simplify the complex journey of obtaining visas and travel documents, ensuring that your aspirations are within reach.
                            With a commitment to excellence and a wealth of experience in the field, our dedicated team of experts is here to guide you through the intricate web of visa processes. We understand that every journey is unique, and we tailor our services to meet your specific needs. </p>
                    ...
                    <div className="card shrink-0 w-1/2 max-w-sm ">
